#!/bin/bash
# Usage: ./cra_to_vite_with_preflight_and_backend.sh <github-username> <repo-name> [backend-start-command]
...
echo "✅ Migration complete: CRA removed, Vite configured for port 40001 frontend + proxy to localhost:4002 backend, backend auto-started if needed, both states backed up to GitHub."
